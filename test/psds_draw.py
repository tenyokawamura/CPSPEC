...
def main():
    # ----- Setting ----- #
    names_infits=[\
        './ni1200120147_0mpu7_cl_bary_fpm_0101_0260_psd.fits',\
        './ni1200120147_0mpu7_cl_bary_fpm_0261_0480_psd.fits',\
        './ni1200120147_0mpu7_cl_bary_fpm_0481_0700_psd.fits',\
        './ni1200120147_0mpu7_cl_bary_fpm_0701_1100_psd.fits'\
        ]
    ch_ref_min=261
    ch_ref_max=480
    chs_min   =[101, ch_ref_min, 481, 701 ]
    chs_max   =[260, ch_ref_max, 700, 1100]
    name_outpdf='./ni1200120147_0mpu7_cl_bary_fpm_psds.pdf'
