...
def main():
    ...
    for i_n, (ch_min, ch_max) in enumerate(zip(inputs_xspec.chs_min, inputs_xspec.chs_max)):
        ...
        csds_ph    =csds_ph    [inputs_xspec.i_f_min:inputs_xspec.i_f_max]
        dcsds_ph   =dcsds_ph   [inputs_xspec.i_f_min:inputs_xspec.i_f_max]
        ...
        in zip(chs_rebin_min, chs_rebin_max, csds_ph, dcsds_ph, dfs_rebin):
            ...
            syses_err[ch_rebin_min]=inputs_xspec.sys_err_csd_phase
        ...
        name_outpha=inputs_xspec.name_inevt.replace('.evt', '_{0:04}_{1:04}_{2:04}_{3:04}_csd_phase.pha'.format(int(ch_min), int(ch_max), int(inputs_xspec.ch_ref_min), int(inputs_xspec.ch_ref_max)))
