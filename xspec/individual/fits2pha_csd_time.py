...
def main():
    ...
    name_outpha_def='./ni1200120110_csd_time.pha'
    ...
    for i_b in is_b:
        ...
        csds_ti_mea=hdus[i_b+2].data['LAGM']
        csds_ti_sig=hdus[i_b+2].data['LAGS']
        ...
        csds_ti_mea=csds_ti_mea[i_f_min:i_f_max]
        csds_ti_sig=csds_ti_sig[i_f_min:i_f_max]
        ...
        for ch_rebin_min, ch_rebin_max, csd_ti_mea, csd_ti_sig, df\
        in zip(chs_rebin_min, chs_rebin_max, csds_ti_mea, csds_ti_sig, dfs):
            # df is necessary for XSPEC to show fP(f) with 'plot euf'.
            rates[ch_rebin_min]=csd_ti_mea*df 
            stats_err[ch_rebin_min]=csd_ti_sig*df
