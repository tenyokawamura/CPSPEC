...
names_outtxt=[\
    'ni1200120130_0mpu7_cl_fpm_0101_0260_0261_0480_csd_time.txt'\
    ]

xspec.AllData('\
    1:1 ni1200120130_0mpu7_cl_fpm_0101_0260_0261_0480_csd_time.pha \
    ')
...
for i, name_outtxt in enumerate(names_outtxt):
    ...
    with open(name_outtxt, 'w') as fout:
        str_header='#f[Hz] df[Hz] tau[s] dtau[s]\n'
